                ...
                <form method="post" action="php/process-new-Medicijn.php">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="inputMedicijnNaam" name="inputMedicijnNaam" placeholder="naam" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="medicijnBeschrijving">Beschrijving</label>
                            <input type="text" class="form-control" id="inputBeschrijving" name="inputBeschrijving" placeholder="beschrijving" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="dosis">Dosis</label>
                            <input type="text" class="form-control" id="inputDosis" name="inputDosis" placeholder="dosis" required>
                        </div>
                    </div>
                    <button class="btn btn-success" type="submit">Sla medicijn op</button>
                    <a class="btn btn-secondary" href="Medicijnen.php">Terug</a>
                </form>
            </div>
        </div>
    </div>
