                ...
                <form method="post" action="../php/process-add-patient.php">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="inputEmailPatient" name="inputEmailPatient" placeholder="email" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="email van Dokter"> email van dokter</label>
                            <input type="text" class="form-control" id="inputEmailDokter" name="inputEmailDokter" placeholder="email" required>
                        </div>
                    </div>
                    <div class="form-row">
                    <button class="btn btn-success" type="submit">Patiënt toevoegen</button>
